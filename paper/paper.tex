...
However, the degree with lowest validation error was 13.  Training error for the 13th degree polynomial was 0.384.
...
However, the number of RBF kernels with lowest validation error was 9.  Training error was 0.337.
