...
\paragraph
1 The following plots demonstrate the results of Logistic Regression with iterations = 2000, learning rate $\eta$ = 1 and varying degrees $l$ = \{1, 2, 5, 15\}:
...
Train set error : GDad have smaller train error(0.308) than non-adaptive GD(0.336).\\
Test set error : GDad have bigger test error(0.359) than non-adaptive GD(0.328).\\
\\
\textbf{Degree $l$ = 15 :}\\
Spped : GDad reaches near the local minima faster than non-adaptive gradient.\\
Train set error : GDad have smaller train error(0.209) than non-adaptive GD(0.323).\\
Test set error : GDad have bigger test error(0.399) than non-adaptive GD(0.357).\\
\\
\\
